export default {
  ...
  settings: {
    ...
    apiTokenPlaceholder: 'Insira seu token da API. Ele é salvo apenas no seu dispositivo.',
    apiTokenHelp: 'O token requer permissões de Zone.DNS.',
  ...
  dns: {
    ...
    analytics: {
      title: 'DNS Analytics',
      placeholder: 'O conteúdo de Analytics será implementado aqui.',
    },
    settings: {
