export default {
  ...
  dns: {
    ...
    analytics: {
      ...
      totalQueriesHelp: 'Total number of DNS queries in the selected time range.',
      avgQueriesPerSecond: 'Avg QPS',
      avgQueriesPerSecondHelp: 'Average queries per second.',
      avgProcessingTime: 'Avg Processing Time',
      avgProcessingTimeHelp: 'Average time to process a query.',
