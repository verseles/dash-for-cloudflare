  ...
  group('PagesProjectsNotifier Unit Tests', () {
    ...
    test('loads from cache and refreshes in background', () async {
      ...
      await Future.delayed(const Duration(milliseconds: 100));
          ...
          test('deleteProject calls API and invalidates cache', () async {
            ...
            final mockResponse = CloudflareResponse<DeleteResponse>(
              ...
              success: true,
                      ...
                      result: const DeleteResponse(id: 'test-project'),
                  ...
                  when(() => mockApi.deletePagesProject(accountId, projectName))
                  ...
                  when(() => mockPrefs.remove(any())).thenAnswer((_) async => true);
                        ...
                        when(() => mockApi.getPagesProjects(accountId, page: any(named: 'page')))
                            ...
                            .thenAnswer((_) async => CloudflareResponse<List<PagesProject>>(
                        ...
                        when(() => mockPrefs.setString(any(), any())).thenAnswer((_) async => true);
                              ...
                              final success = await container.read(pagesProjectsNotifierProvider.notifier).deleteProject(projectName);
                              ...
                              verify(() => mockApi.deletePagesProject(accountId, projectName)).called(1);
